export const en = {
  ...
  settings: {
    ...
    notificationsEnabled: 'Notifications activated successfully.',
    notificationsError: 'Could not activate notifications. Check your device permissions.',
    notificationsSignInRequired: 'Sign in to enable notifications.',
