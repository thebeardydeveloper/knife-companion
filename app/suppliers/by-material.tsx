...
export default function SuppliersByMaterialScreen() {
  ...
  return (
    <View style={[styles.screen, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <H2 style={styles.headerTitle}>{t('suppliers.byMaterialTitle')}</H2>
      </View>
      ...
      <View style={styles.searchBar}>
        ...
        <TextInput
          ...
          placeholder={t('suppliers.materialPlaceholder')}
